...
@st.cache
def get_data():
    df = pd.read_excel(r"C:\Users\michael.dodd\Data\Equity\SA_Indices.xlsx", sheet_name='Prices', index_col=0)
    prices_df = pd.read_excel(r"C:\Users\michael.dodd\Data\Equity\SWIXShares.xlsx", parse_dates=['CLOSE'], index_col=0)
    stocks_df = pd.read_excel(r"C:\Users\michael.dodd\Data\Equity\AllJSEShares.xlsx")
    benchmark = pd.read_excel(r"C:\Users\Michael.Dodd\OneDrive - Old Mutual\Investment Team Documents\Team Workings\Michael Dodd\Equity\Manager Monitoring\Prudential\Manager Monitoring - Prudential.xlsx", sheet_name='SWIX Holdings', index_col=0)
...
smallcap = ['ACL', 'ADH', 'AEL', 'AFE', 'AFH', 'AFT', 'AIL', 'AIP', 'ARL', 'ATT', 'BAT', 'BLU', 'CLH', 'COH', 'CSB', 'DRD', 'DTC', 'EMI', 'EQU', 'FBR', 'FTB', 'GND', 'HCI', 'HDC', 'HYP', 'IPF', 'JSE', 'KAP', 'KRO', 'KST', 'L2D', 'LBR', 'LTE', 'MLI', 'MSM', 'MSP', 'MTA', 'MTH', 'MUR', 'OCE', 'OMN', 'PAN', 'PPC', 'RBX', 'RFG', 'RLO', 'SAC', 'SNH', 'SPG', 'SSS', 'SUI', 'TGA', 'TGO', 'THA', 'TSG', 'VKE', 'WBO', 'ZED']
...
cons_disc = ['ADH', 'CFR', 'CLH', 'COH', 'CSB', 'FBR', 'ITE', 'MRP', 'MSM', 'MTA', 'MTH', 'PPH', 'SNH', 'SUI', 'TFG', 'TGO', 'TRU', 'TSG', 'WHL']
